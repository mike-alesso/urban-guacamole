 ...
 */
    ...
    public CustomNoteAdapter(Context context, ArrayList<Note> note) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.note_edit, parent, false);
            }
            // Lookup view for data population
            TextView tvNoteName = (TextView) convertView.findViewById(R.id.tvNoteName);
            TextView tvAssessmentId = (TextView) convertView.findViewById(R.id.tvNoteId);
            // Populate the data into the template view using the data object
            tvAssessmentId.setText(String.valueOf(note.getNoteId()));
